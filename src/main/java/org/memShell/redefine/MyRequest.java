...
public class MyRequest {
	...
	public static int getContentLength(Object request) throws Exception {
		return Integer.parseInt(
				request.getClass().getMethod("getContentLength", null).invoke(request, new Object[] {}).toString());
	}
	...
	public static Enumeration getHeaderNames(Object request) throws Exception {
		return (Enumeration) request.getClass().getMethod("getHeaderNames", null).invoke(request, new Object[] {});
	}
